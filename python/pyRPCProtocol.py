...
class RPCProtocol:
    def __init__(self, comport_path, baud, xml_search_dir):
        ...
        self.rpc_json_bridge_process = subprocess.Popen(["/home/pi/JSONtoRPCbridge/bin/release/consoleapp", comport_path, str(baud), xml_search_dir], env=my_env, cwd=r'../', stdin=subprocess.PIPE,stdout=subprocess.PIPE, shell = False)
...
proto = RPCProtocol("/dev/ttyS0",115200,"/home/pi/thf_logger/xml_rpc/")
